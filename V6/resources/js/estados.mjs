/**
 * @author Santiago Rivera Marin (SRM-TRG); 2024-2
 */
  ...
  static #verifyBeforeAdd(states) {
    ...
    switch (lastState) {
      ...
      case 'ENVIADO':
        ...
        break;
      case 'EN_CAMINO':
        console.warn('Cómo podria hacerse la verificación adicional?, digo, con lo que hice en la línea 271, me ahorro esta verificación');
        break;
      default:
